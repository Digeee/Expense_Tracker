      ...
      <div className="relative z-10">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="mb-4 text-body text-gray-700 dark:text-gray-300 font-bold">Track your expenses and manage your budget with ease.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start p-3 rounded-xl neumorphic-inset">
                ...
                <div>
                  ...
                  <p className="text-sm text-body text-gray-600 dark:text-gray-400 font-bold">Click the "Add Expense" button to record new expenses</p>
                </div>
              </div>
              ...
              <div className="flex items-start p-3 rounded-xl neumorphic-inset">
                ...
                <div>
                  ...
                  <p className="text-sm text-body text-gray-600 dark:text-gray-400 font-bold">Use the action buttons to modify or remove expenses</p>
                </div>
              </div>
              ...
              <div className="flex items-start p-3 rounded-xl neumorphic-inset">
                ...
                <div>
                  ...
                  <p className="text-sm text-body text-gray-600 dark:text-gray-400 font-bold">Use filters to view expenses by category or date range</p>
                </div>
              </div>
              ...
              <div className="flex items-start p-3 rounded-xl neumorphic-inset">
                ...
                <div>
                  ...
                  <p className="text-sm text-body text-gray-600 dark:text-gray-400 font-bold">View charts to understand your spending patterns</p>
                </div>
              </div>
            </div>
          </div>
