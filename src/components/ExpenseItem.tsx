  ...
  return (
    ...
    >
      <div className="col-span-5">
        ...
        {expense.notes && (
          <div className="text-sm text-gray-500 dark:text-gray-400 mt-1 flex items-start gap-2 font-extrabold">
      ...
      <div className="col-span-2 text-gray-500 dark:text-gray-400 font-extrabold">
